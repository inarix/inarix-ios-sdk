...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "InarixSDK", url: "https://storage.googleapis.com/prod-inarix-public/dev/InarixSDK_v0.5.5-beta.xcframework.zip", checksum: "5c2650055a0693bce7d2173d2219d221f871b972601aeb3d339fe17b5edb2e95"),
        .testTarget(
