...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "InarixSDK", url: "https://storage.googleapis.com/prod-inarix-public/dev/InarixSDK_v0.4.8-beta.xcframework.zip", checksum: "797ec22992be37ee8777350ccdb722a4928979162b665fd9d098ef960c469669"),
        .testTarget(
