...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "InarixSDK", url: "https://storage.googleapis.com/prod-inarix-public/dev/InarixSDK_v0.4.2-beta.xcframework.zip", checksum: "a8fa645304ba7cd48e6754c46331f887e9a587d62b5e438cd791c818dc644da6"),
        .testTarget(
