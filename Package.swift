...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "InarixSDK", url: "https://storage.googleapis.com/prod-inarix-public/test/InarixSDK_v1.1.1-test.xcframework.zip", checksum: "eb83f562dc090ed7f9f567325b1ce216fdceea3087f1a1fa19fe18424199fea1"),
        .testTarget(
