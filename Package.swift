...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "InarixSDK", url: "https://storage.googleapis.com/prod-inarix-public/exp/InarixSDK_v0.7.1-exp.xcframework.zip", checksum: "22a1ee9b6d755b478ffa5b15efbfe37fabc5d8c5cca9c1bacc95151a99b58dd1"),
        .testTarget(
