...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "InarixSDK", url: "https://storage.googleapis.com/prod-inarix-public/dev/InarixSDK_v0.6.9-beta.xcframework.zip", checksum: "32c59de7fb528bc91191dcfaf48cefd7457e2dc9fad299ede94f2663aed03f83"),
        .testTarget(
