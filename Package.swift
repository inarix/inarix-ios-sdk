...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "InarixSDK", url: "https://storage.googleapis.com/prod-inarix-public/dev/InarixSDK_v1.0.1-beta.xcframework.zip", checksum: "abcd347618ffbcea848f74b0a04bed5018db5a9a0a37d0573baccdda407077df"),
        .testTarget(
