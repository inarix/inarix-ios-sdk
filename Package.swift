...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "InarixSDK", url: "https://storage.googleapis.com/prod-inarix-public/exp/InarixSDK_v1.0.2-exp.xcframework.zip", checksum: "a3092023397f4aa7a9b317127ac2fd6ff41591305cf0e485c733b8b17ae9450b"),
        .testTarget(
