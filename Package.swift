...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "InarixSDK", url: "https://storage.googleapis.com/prod-inarix-public/dev/InarixSDK_v0.5.4-beta.xcframework.zip", checksum: "22f60ddb8412268c7de190acccde233e68d6cafd8cfbfd7a01a564afa6074c11"),
        .testTarget(
