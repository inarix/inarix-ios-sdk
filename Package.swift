...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "InarixSDK", url: "https://storage.googleapis.com/prod-inarix-public/dev/InarixSDK_v0.6.8-beta.xcframework.zip", checksum: "5fbad0d8852eb59a0f4ab0eece932e92332d4f52bc6ceb8fd7e014be121fdd99"),
        .testTarget(
