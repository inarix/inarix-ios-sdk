...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "InarixSDK", url: "https://storage.googleapis.com/prod-inarix-public/dev/InarixSDK_v0.5.0-beta.xcframework.zip", checksum: "084346e6ba4218cd25e70c96e62fbdbcf3b993fcf7bc5e23181740e8727cc253"),
        .testTarget(
