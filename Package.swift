...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "InarixSDK", url: "https://storage.googleapis.com/prod-inarix-public/dev/InarixSDK_v0.5.3-beta.xcframework.zip", checksum: "42fb9a02bd8c99ac6a75fa93dd941477cb99842a9c6afd48e63531e9eca70467"),
        .testTarget(
