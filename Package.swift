...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "InarixSDK", url: "https://storage.googleapis.com/prod-inarix-public/dev/InarixSDK.xcframework.zip", checksum: "5f2b20c09e879936d7b4bf7c56f5a4e83c20cf90b8e0ef29883323c1ea220638"),
        .testTarget(
