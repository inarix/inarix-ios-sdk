...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "InarixSDK", url: "https://storage.googleapis.com/prod-inarix-public/dev/InarixSDK_v0.6.2-beta.xcframework.zip", checksum: "a16176cc178a7937c955f967d24e366393088ff03e032e49a2393c992bcd02fc"),
        .testTarget(
