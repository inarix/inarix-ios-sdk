...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "InarixSDK", url: "https://storage.googleapis.com/prod-inarix-public/dev/InarixSDK_v0.4.1-beta.xcframework.zip", checksum: "5dd212908532793a63cf9033d93039147187e7214338b7e52fbb2b1e32a98dab"),
        .testTarget(
