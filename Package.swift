...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "InarixSDK", url: "https://storage.googleapis.com/prod-inarix-public/exp/InarixSDK_v0.7.6-exp.xcframework.zip", checksum: "c539706aea21e61d74e6b5a57e3385aaeab0142b5b20709ad229875487c3c2fb"),
        .testTarget(
