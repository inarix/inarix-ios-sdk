...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "InarixSDK", url: "https://storage.googleapis.com/prod-inarix-public/dev/InarixSDK_v0.6.0-beta.xcframework.zip", checksum: "6a1c4fe46004690d5327737477a09f0147db7f1339f6dbf89bc0a1d33c5d60c1"),
        .testTarget(
