...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "InarixSDK", url: "https://storage.googleapis.com/prod-inarix-public/dev/InarixSDK_v0.2.8-alpha.xcframework.zip", checksum: "33219cf7fafc973854138a13e933bfa96953e2e0a8b5e06ae68f554d12fa4683"),
        .testTarget(
