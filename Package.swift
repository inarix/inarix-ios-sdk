...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "InarixSDK", url: "https://storage.googleapis.com/prod-inarix-public/exp/InarixSDK_v0.9.2-exp.xcframework.zip", checksum: "072e484fcef6f20a3bbf10efbae455f2c985ba8e19faf0c88b01ae817c904b19"),
        .testTarget(
