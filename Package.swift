...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "InarixSDK", url: "https://storage.googleapis.com/prod-inarix-public/exp/InarixSDK_v0.8.91-exp.xcframework.zip", checksum: "1e99f145fdfbd19d2a6cda15ab65a3e9247f22ccdad47740cfdb85fe10520244"),
        .testTarget(
