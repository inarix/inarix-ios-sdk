...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "InarixSDK", url: "https://storage.googleapis.com/prod-inarix-public/dev/InarixSDK_v0.3.0-beta.xcframework.zip", checksum: "d2c8b67739441f279911a53bbbcb0de6cfe62ff76dbceccebc60088fcbec3efb"),
        .testTarget(
