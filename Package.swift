...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "InarixSDK", url: "https://storage.googleapis.com/prod-inarix-public/dev/InarixSDK_v0.1.5.xcframework.zip", checksum: "245c2f5b8142e8b338136addfd134a13a87874dcfe2b3dba3992545e4a20dfe3"),
        .testTarget(
