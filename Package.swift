...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "InarixSDK", url: "https://storage.googleapis.com/prod-inarix-public/dev/InarixSDK_v0.4.3-beta.xcframework.zip", checksum: "519dfaaf944321b627c8aabb2e4adc158764f8a239089f8873c140cb91f5a310"),
        .testTarget(
