...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "InarixSDK", url: "https://storage.googleapis.com/prod-inarix-public/exp/InarixSDK_v0.7.4-exp.xcframework.zip", checksum: "818bf93baabbb276f06837d78e5afde58795d766e1dd7dcf82ac7176ef78f9a4"),
        .testTarget(
