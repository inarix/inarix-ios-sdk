...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "InarixSDK", url: "https://storage.googleapis.com/prod-inarix-public/exp/InarixSDK_v0.6.6-exp.xcframework.zip", checksum: "f368941320d52eb72f4f2bc5a5ee80d33baa89050873174564a15e03c669862d"),
        .testTarget(
