...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "InarixSDK", url: "https://storage.googleapis.com/prod-inarix-public/dev/InarixSDK_v0.2.0-alpha.xcframework.zip", checksum: "b37e1fffcf2aaba917767d6881e873ff7ecb7d447195ac08ad5f0c13e29d9c11"),
        .testTarget(
