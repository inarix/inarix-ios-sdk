...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "InarixSDK", url: "https://storage.googleapis.com/prod-inarix-public/dev/InarixSDK_v0.3.8.1-beta.xcframework.zip", checksum: "071d325fecdd67cc31f2f9f566d048b3068279e3a7ca0153bc50ab5be055b406"),
        .testTarget(
