...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "InarixSDK", url: "https://storage.googleapis.com/prod-inarix-public/test/InarixSDK_v1.0.4-test.xcframework.zip", checksum: "232b148f3af5ef9cef19285c70a57ccddd69061f97a5cd826846faabfb6caa4a"),
        .testTarget(
