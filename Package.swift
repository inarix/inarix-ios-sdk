...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "InarixSDK", url: "https://storage.googleapis.com/prod-inarix-public/dev/InarixSDK_v0.6.5-beta.xcframework.zip", checksum: "9e833b61003286e571ecd11b50df18aad6d20bc2bb594e579dde08b73fbffec5"),
        .testTarget(
