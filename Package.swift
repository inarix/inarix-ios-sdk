...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "InarixSDK", url: "https://storage.googleapis.com/prod-inarix-public/dev/InarixSDK_v0.1.7.xcframework.zip", checksum: "bd2da2028d41e68d39959ac06764ef900424d7837b9f89c44a8d48c0aa8f96ec"),
        .testTarget(
