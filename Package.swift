...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "InarixSDK", url: "https://storage.googleapis.com/prod-inarix-public/exp/InarixSDK_v0.9.1-exp.xcframework.zip", checksum: "eecf6af2f118e8d70131ce8201c7785ed32dcd4dc9c54c419989485476c483fd"),
        .testTarget(
