...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "InarixSDK", url: "https://storage.googleapis.com/prod-inarix-public/exp/InarixSDK_v0.8.6-exp.xcframework.zip", checksum: "df7b61345495f5d2e896e6eb212c4f6fa8ef1f83fa6f5476b51b80a271491649"),
        .testTarget(
