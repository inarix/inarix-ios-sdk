...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "InarixSDK", url: "https://storage.googleapis.com/prod-inarix-public/exp/InarixSDK_v0.8.8-exp.xcframework.zip", checksum: "2b4450ad9ec6d93c932f8691839d42f95774830c4bd002281c507ea7decf108d"),
        .testTarget(
