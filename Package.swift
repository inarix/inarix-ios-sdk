...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "InarixSDK", url: "https://storage.googleapis.com/prod-inarix-public/dev/InarixSDK_v0.2.0-alpha.xcframework.zip", checksum: "f16e7388b4b9f24b935831dbf3e89971b6f35b88d012d6b800b8c6876e403b84"),
        .testTarget(
