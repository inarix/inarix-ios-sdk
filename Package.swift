...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "InarixSDK", url: "https://storage.googleapis.com/prod-inarix-public/dev/InarixSDK_v0.1.6.xcframework.zip", checksum: "2710f5952b24b96d7fe0a0d3c87c27584bd15a217aa74a707baf0262c287e1a2"),
        .testTarget(
