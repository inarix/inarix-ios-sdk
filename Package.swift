...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "InarixSDK", url: "https://storage.googleapis.com/prod-inarix-public/dev/InarixSDK_v0.3.4-beta.xcframework.zip", checksum: "a4f222906e03a5acda7d097107026ff91a90056495eaa6bca7521388101ad312"),
        .testTarget(
