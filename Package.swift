...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "InarixSDK", url: "https://storage.googleapis.com/prod-inarix-public/test/InarixSDK_v0.0.1-test.xcframework.zip", checksum: "24521b4f640e85a6d211b0c5d631e4cd1aa50cf394efda4c251eeffd7ddaff97"),
        .testTarget(
