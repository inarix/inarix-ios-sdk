...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "InarixSDK", url: "https://storage.googleapis.com/prod-inarix-public/dev/InarixSDK_v0.1.8.xcframework.zip", checksum: "a60f687efa0ee44a94f6035824f263ff21b058cd151f81521420e506088102f1"),
        .testTarget(
