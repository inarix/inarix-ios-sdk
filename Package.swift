...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "InarixSDK", url: "https://storage.googleapis.com/prod-inarix-public/dev/InarixSDK_v0.3.9-beta.xcframework.zip", checksum: "ee556cb35c3031cf901f4779181d3e248f86a74e84e8bb061a4b31926ea7e293"),
        .testTarget(
