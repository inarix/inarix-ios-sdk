...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "InarixSDK", url: "https://storage.googleapis.com/prod-inarix-public/dev/InarixSDK_v0.5.91-beta.xcframework.zip", checksum: "1b86c1c6d91aa9dec571bca74bde69c2064833b1b418acb2bbb6b25c4d7b56a9"),
        .testTarget(
