...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "InarixSDK", url: "https://storage.googleapis.com/prod-inarix-public/exp/InarixSDK_v0.8.4-exp.xcframework.zip", checksum: "8d1ca7185d5ca47a48a2f24211da11397fa3837dfcdf692ee3b410bf6e435ab7"),
        .testTarget(
