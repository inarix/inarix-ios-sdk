...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "InarixSDK", url: "https://storage.googleapis.com/prod-inarix-public/dev/InarixSDK_v0.5.8-beta.xcframework.zip", checksum: "733bd596a615a9b0609e1e8e407283a681cefdc19955c1a6b6ac64ed641e557d"),
        .testTarget(
