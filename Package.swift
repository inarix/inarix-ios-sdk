...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "InarixSDK", url: "https://storage.googleapis.com/prod-inarix-public/dev/InarixSDK_v0.6.1-beta.xcframework.zip", checksum: "636b5ea9ee5d47baf935c3a75a35058d159f3b2756b7c1073436aae9a936d3ff"),
        .testTarget(
