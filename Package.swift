...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "InarixSDK", url: "https://storage.googleapis.com/prod-inarix-public/exp/InarixSDK_v0.8.92-exp.xcframework.zip", checksum: "8d2b17fca9d5bb76a9f90d9e68694313bc32fb39377cb01965fa9a8235d471c7"),
        .testTarget(
