...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "InarixSDK", url: "https://storage.googleapis.com/prod-inarix-public/dev/InarixSDK_v0.6.6-beta.xcframework.zip", checksum: "91d09a055f99b1b67643af98c0a3ff13b173c82289afa788cf261e790056c766"),
        .testTarget(
