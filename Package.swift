...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "InarixSDK", url: "https://storage.googleapis.com/prod-inarix-public/dev/InarixSDK_v0.5.7-beta.xcframework.zip", checksum: "741ad231f82f86772463402e369ae688e005597c60cb21b8fdcbfb28f4afeb5a"),
        .testTarget(
