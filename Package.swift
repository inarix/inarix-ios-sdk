...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "InarixSDK", url: "https://storage.googleapis.com/prod-inarix-public/dev/InarixSDK.xcframework.zip", checksum: "4afa0ebd7431831a3869b195baec91f7736fedf8f5ad96a1d38a32535bce239b"),
        .testTarget(
