...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "InarixSDK", url: "https://storage.googleapis.com/prod-inarix-public/dev/InarixSDK_v0.3.2-beta.xcframework.zip", checksum: "d29dc6ecc31d774d8835a857de2eabc3da89ff78afd17a08d023b068ada7449a"),
        .testTarget(
