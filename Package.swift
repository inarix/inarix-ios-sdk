...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "InarixSDK", url: "https://storage.googleapis.com/prod-inarix-public/dev/InarixSDK_v0.2.3-alpha.xcframework.zip", checksum: "3019cfc515707f92160bc9a8b0868b86db723235189b9691b4cbc33bee60daa3"),
        .testTarget(
