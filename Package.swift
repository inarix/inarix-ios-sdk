...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "InarixSDK", url: "https://storage.googleapis.com/prod-inarix-public/exp/InarixSDK_v0.8.9-exp.xcframework.zip", checksum: "1aa3d00a14db5452a5b030033056dfcff1faef25ea3fd49e414d3222b4bf1f0d"),
        .testTarget(
