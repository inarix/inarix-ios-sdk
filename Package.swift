...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "InarixSDK", url: "https://storage.googleapis.com/prod-inarix-public/dev/InarixSDK_v0.1.1.xcframework.zip", checksum: "89a4142ed9f3bf619a211dff02ae14721a01d925a7267d5cb015502ccbec8556"),
        .testTarget(
