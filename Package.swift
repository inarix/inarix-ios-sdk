...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "InarixSDK", url: "https://storage.googleapis.com/prod-inarix-public/exp/InarixSDK_v0.7.2-exp.xcframework.zip", checksum: "2d716e73429be5aa91ddea08d2619c50fe8691579cb78f4a74f905d13fd665ee"),
        .testTarget(
