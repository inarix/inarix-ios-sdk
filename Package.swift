...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "InarixSDK", url: "https://storage.googleapis.com/prod-inarix-public/dev/InarixSDK_v0.1.3.xcframework.zip", checksum: "ab552a33e3b74a990ae8c9aedb3c73b748a41ccde09a62c0ff5d364770970530"),
        .testTarget(
