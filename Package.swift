...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "InarixSDK", url: "https://storage.googleapis.com/prod-inarix-public/dev/InarixSDK_v0.3.1-beta.xcframework.zip", checksum: "0db075d6a268e928da6ccc754b68697e6f3be6ba816c32fb905cb541166a0a88"),
        .testTarget(
