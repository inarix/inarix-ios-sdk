...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "InarixSDK", url: "https://storage.googleapis.com/prod-inarix-public/dev/InarixSDK_v1.0.0-beta.xcframework.zip", checksum: "bcf59c109e2ee33453b47ddb1d71724dd82df2475da12c391f92bcc1e9a4188d"),
        .testTarget(
