...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "InarixSDK", url: "https://storage.googleapis.com/prod-inarix-public/dev/InarixSDK_v0.4.5-beta.xcframework.zip", checksum: "9f04020d14d535c161a858df5d79ded3b9df90da96b936cbe94d51dc1a0330bb"),
        .testTarget(
