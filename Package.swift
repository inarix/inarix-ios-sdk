...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "InarixSDK", url: "https://storage.googleapis.com/prod-inarix-public/dev/InarixSDK_v0.5.2-beta.xcframework.zip", checksum: "2fee3a5be611063295689d2b4bd10fd7c3edfcc8481cba16a026dcc8715851e3"),
        .testTarget(
