...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "InarixSDK", url: "https://storage.googleapis.com/prod-inarix-public/exp/InarixSDK_v0.7.8-exp.xcframework.zip", checksum: "3b530886c66266e00d1b1a3dee9d6f705bcf02ea01aed5b87b20f7f2c6416369"),
        .testTarget(
