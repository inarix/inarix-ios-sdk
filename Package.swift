...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "InarixSDK", url: "https://storage.googleapis.com/prod-inarix-public/dev/InarixSDK_v0.1.2.xcframework.zip", checksum: "dc6ee15e2bb4f1aa6b061299fab4f866fea95487b215d361b0a9a197e59e25f8"),
        .testTarget(
