...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "InarixSDK", url: "https://storage.googleapis.com/prod-inarix-public/dev/InarixSDK_v0.4.0-beta.xcframework.zip", checksum: "3f6b5b5fca7a4dc0f2c124c453eb4f2036d467076ebdda8f44f6646c79670bef"),
        .testTarget(
