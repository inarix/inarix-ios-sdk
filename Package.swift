...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "InarixSDK", url: "https://storage.googleapis.com/prod-inarix-public/dev/InarixSDK_v0.8.7-exp.xcframework.zip", checksum: "420f094e99084ce3aa96421edf8511138d6730098582ebe9eef5d09f453b0307"),
        .testTarget(
