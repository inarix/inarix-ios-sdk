...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "InarixSDK", url: "https://storage.googleapis.com/prod-inarix-public/dev/InarixSDK_v0.5.6-beta.xcframework.zip", checksum: "33358f490cc5d374925434b0410e390269ee47d500ba9583695c041580128473"),
        .testTarget(
