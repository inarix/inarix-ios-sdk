...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "InarixSDK", url: "https://storage.googleapis.com/prod-inarix-public/exp/InarixSDK_v1.0.3-exp.xcframework.zip", checksum: "f60bf38a9c9ddbe9c3924ec6c88decd2a76b0fbb34b062885e3926935778e007"),
        .testTarget(
