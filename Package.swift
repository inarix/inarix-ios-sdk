...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "InarixSDK", url: "https://storage.googleapis.com/prod-inarix-public/dev/InarixSDK_v1.0.4-beta.xcframework.zip", checksum: "45a276704680d51a6717126a2b30c0ddb937b4b90b33d09493697b9a739d1bd2"),
        .testTarget(
