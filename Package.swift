...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "InarixSDK", url: "https://storage.googleapis.com/prod-inarix-public/exp/InarixSDK_v0.8.93-exp.xcframework.zip", checksum: "5cc5c7feb3f36284c016083469cc432843404d5bf0d116e21b3fcc9f0355697f"),
        .testTarget(
