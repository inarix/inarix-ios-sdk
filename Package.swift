...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "InarixSDK", url: "https://storage.googleapis.com/prod-inarix-public/dev/InarixSDK_v0.5.9-beta.xcframework.zip", checksum: "f8fab1a46ff87bd8a7e5df1e0b93cfdc52092f2700c73d9600657ec94615132d"),
        .testTarget(
