...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "InarixSDK", url: "https://storage.googleapis.com/prod-inarix-public/exp/InarixSDK_v0.6.9-beta.xcframework.zip", checksum: "99d9ff6cd1b860982db287e28ff8ab9a6d362cc90512338330fef4ce72cc4242"),
        .testTarget(
