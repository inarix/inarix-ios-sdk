...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "InarixSDK", url: "https://storage.googleapis.com/prod-inarix-public/exp/InarixSDK_v0.8.3-exp.xcframework.zip", checksum: "c296b27edf95a3dc636d41d8d211625807dd7788f3001ec87b694781c1ebd59f"),
        .testTarget(
