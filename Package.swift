...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "InarixSDK", url: "https://storage.googleapis.com/prod-inarix-public/dev/InarixSDK_v0.6.3-beta.xcframework.zip", checksum: "02cae87a1ed2b721348e0833bfd6c5ef00d54aed97acc63c0a8ae3e98887f12a"),
        .testTarget(
